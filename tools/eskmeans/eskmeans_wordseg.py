...
def main():
    ...
    landmarks_pkl_path = '../syllables/landmarks/landmarks_syllable_seg.pkl'
    with open(landmarks_pkl_path, 'rb') as handle:
    ...
    with open(embed_dur_dic_path, 'rb') as handle:
    ...
    with open("results/" + args.data_name + ".pkl", "wb") as f:
        segmenter.save(f)
