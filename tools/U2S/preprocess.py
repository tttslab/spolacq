...
if __name__ == "__main__":
    ...
    foods = [
        'apple', 'banana', 'carrot', 'cherry', 'cucumber', 'egg', 'eggplant',
        'green_pepper', 'hyacinth_bean', 'kiwi_fruit', 'lemon', 'onion',
        'orange', 'potato', 'sliced_bread', 'small_cabbage', 'strawberry',
        'sweet_potato', 'tomato', 'white_radish',
        ]
